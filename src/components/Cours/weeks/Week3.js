        ...
        return (
            <div>
                ...
                <button onClick={onClickHandler}>Clic!</button>
                    ...
                    <p>La modification du state implique le respect de règles concernant l'immuabilité de celui-ci. Voir les Références pour la <A internal={true} url="/references">manipulation d'un state à tableaux ou à objets</A>.</p>
                </Groupe>
